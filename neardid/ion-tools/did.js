...
const Near = require('@decentralized-identity/ion-tools')
// const Near = require('../ion-tools')
...
const main = async () => {
    ...
    // const anchorRequest = new Near.AnchorRequest(anchorRequestBody)
    // const anchorResponse = await anchorRequest.submit()
    // console.log("Anchor response", anchorResponse)

    // const response = await Near.resolve('did:near:EiCjHFpU1Fm6Qnq7XIj_Gt2QGCpnwQrrnUWoVrM4H9we1A')
    ...
    // const signature = await Near.signJws({
    //     payload: myData,
    //     privateJwk: privateKey
    // });
    // console.log("Signed JWS:", signature)

    // const randomKeyPair = await Near.generateKeyPair('secp256k1')
    // let verifiedJws = await Near.verifyJws({
    //     jws: signature,
    ...
    // verifiedJws = await Near.verifyJws({
    //     jws: signature,
    //     publicJwk: publicKey
    // })
